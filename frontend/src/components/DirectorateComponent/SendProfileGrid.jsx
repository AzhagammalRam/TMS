          ...
          <div>
            {params.value?.btn1 && (
              <Button variant="contained" color="primary" onClick={() => handleAction(params.row, "Publish")}>
                <a href='SendProfileEndUser' className='text-white'><FaPaperPlane /></a>
              </Button>
            )}
          </div>
        ),
          ...
          <div className="col-md-12 mb-3">
            <div className="card bg-white">
              <div className="card-header">
                <h4 className='title-clr'><i className="bi bi-table me-2"></i> Send Profile</h4>
              </div>
              ...
              <div className='ms-5'>
                ...
                “Link will be sent to 1560 personnel based on excel data, confirm to proceed”</p>
              </div>
            </div>
          </div>
        </div>
